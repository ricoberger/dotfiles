...
export PATH=$GOROOT/bin:$GOPATH/bin:$HOME/.local/bin:$HOME/.local/bin/nvim-nightly/bin:$HOME/.krew/bin:$HOME/flutter/bin:$HOME/.pub-cache/bin:/opt/homebrew/opt/openjdk/bin:$HOME/.istioctl/bin:$HOME/.cargo/bin:/opt/homebrew/opt/python@3.10/libexec/bin/:$PATH
