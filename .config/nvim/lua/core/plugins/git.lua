    ...
    config = function()
      require("gitsigns").setup({
        ...
        on_attach = function(bufnr)
          ...
          -- Actions
          vim.keymap.set("n", "<leader>gshs", ":Gitsigns stage_hunk<cr>", { desc = "Stage Hunk" })
          vim.keymap.set("n", "<leader>gshr", ":Gitsigns reset_hunk<cr>", { desc = "Reset Hunk" })
          vim.keymap.set("n", "<leader>gshS", gs.stage_buffer, { desc = "Stage all Hunks in Current Buffer" })
          vim.keymap.set("n", "<leader>gshu", gs.undo_stage_hunk, { desc = "Undo Last Hunk" })
          vim.keymap.set("n", "<leader>gshR", gs.reset_buffer, { desc = "Reset all Hunk in Current Buffer" })
          vim.keymap.set("n", "<leader>gshp", gs.preview_hunk, { desc = "Preview Hunk" })
          vim.keymap.set("n", "<leader>gsd", gs.diffthis, { desc = "Diff" })
          vim.keymap.set("n", "<leader>gsD", function()
            gs.diffthis("~")
          end, { desc = "Diff (head)" })
          vim.keymap.set("n", "<leader>gsc", [[<cmd>wincmd p | q<cr>]], { desc = "Diff (Close)" })
          ...
          vim.keymap.set("n", "<leader>gst", gs.toggle_deleted, { desc = "Toggle Deleted" })
